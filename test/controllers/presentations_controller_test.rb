...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { description: @presentation.description, id: @presentation.id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { description: @presentation.description, id: @presentation.id } }
