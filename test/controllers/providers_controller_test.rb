...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { description: @provider.description, id: @provider.id } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { description: @provider.description, id: @provider.id } }
